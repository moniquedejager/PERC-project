...
# model to examine whether it provides a significant difference between pairs of 
# simulations with different densities. 

# We can do this with different parameter settings:
# - density-combinations (also same densties against each other to examine false significant effects)
# - time intervals
# - study durations
